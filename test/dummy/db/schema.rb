...
ActiveRecord::Schema.define(:version => 20150407070559) do

  create_table "smartrent_articles", :force => true do |t|
    t.string   "title"
    t.text     "text"
  ...
  create_table "smartrent_residents", :force => true do |t|
    t.string   "first_name"
    t.string   "last_name"
  ...
  create_table "smartrent_users", :force => true do |t|
    t.string   "email",                  :default => "", :null => false
    t.string   "encrypted_password",     :default => "", :null => false
    t.string   "reset_password_token"
    t.datetime "reset_password_sent_at"
